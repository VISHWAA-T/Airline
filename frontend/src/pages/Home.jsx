        ...
        <div>
            ...
            >
                ...
                <div style={{
                    position: 'absolute',
                    inset: 0,
                    background: 'linear-gradient(180deg, rgba(0,30,80,0.45) 0%, rgba(0,50,130,0.25) 50%, rgba(0,20,60,0.50) 100%)',
                    zIndex: 1,
                    pointerEvents: 'none',
                }} />
                    ...
                    <div style={{
                        ...
                        {[
                            ...
                            <div key={stat.label} style={{ textAlign: 'center' }}>
                                <div style={{ fontSize: '1.7rem', fontWeight: 800, color: '#7ec8ff', textShadow: '0 0 20px rgba(126,200,255,0.5)' }}>{stat.val}</div>
                                <div style={{ fontSize: '0.8rem', opacity: 0.7, letterSpacing: '0.08em', textTransform: 'uppercase' }}>{stat.label}</div>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <div className="container" style={{ marginTop: '-4rem', position: 'relative', zIndex: 10 }}>
                ...
                >
                    {/* Trip Type Selector */}
                    <div style={{ display: 'flex', width: '100%', gap: '0.75rem', marginBottom: '0.5rem', borderBottom: '1px solid #efefef', paddingBottom: '1rem' }}>
                        <button
                            type="button"
                            onClick={() => setTripType('local')}
                            style={{
                                background: tripType === 'local' ? 'linear-gradient(135deg, var(--primary-color) 0%, #173b75 100%)' : 'rgba(255, 255, 255, 0.8)',
                        ...
                        <button
                            ...
                            style={{
                                background: tripType === 'international' ? 'linear-gradient(135deg, var(--primary-color) 0%, #173b75 100%)' : 'rgba(255, 255, 255, 0.8)',
                    ...
                    <div style={{ display: 'flex', alignItems: 'flex-end', height: '100%', paddingTop: '1.5rem' }}>
                        <button type="submit" className="btn btn-primary" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', height: '46px' }}>
